        ...
        <div className="px-1 py-2 mt-2 sm:m-2 sm:p-3 bg-[#FFF]  h-auto flex flex-col jusitfy-around rounded-[5.602px] ">
          ...
          <div className=" flex items-center justify-center content-center py-2 p-1">
            ...
            <div className="flex flex-row h-8  mx-2">
              ...
              <button onClick={increment} className="border-2 bg-white w-7  mb-1 text-blue-600 border-solid hover:text-gray-700 border-blue-400 hover:bg-gray-400 rounded-r text-center flex justify-center ">+</button>
            </div>
          </div>

          <div className="flex flex-col items-center mx-auto ">

            <button className="bg-blue-600 hover:bg-blue-400 text-center text-white font-semibold px-4 py-2 rounded text-xs w-auto">
              Add to Cart
            </button>
